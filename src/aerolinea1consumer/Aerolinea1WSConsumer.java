...
public class Aerolinea1WSConsumer {
    ...
    public static java.util.List<ec.edu.espe.ecutrave.aerolineal.ws.Vuelo> retrieveVuelosByPara(java.lang.String inicio, java.lang.String fin, java.lang.String origen, java.lang.String destino, java.lang.String numPer) {
        ec.edu.espe.ecutrave.aerolineal.ws.AerolineaTamews service = new ec.edu.espe.ecutrave.aerolineal.ws.AerolineaTamews();
        ec.edu.espe.ecutrave.aerolineal.ws.Aerolineaws port = service.getAerolineawsPort();
        return port.retrieveVuelosByPara(inicio, fin, origen, destino, numPer);
    }

    public static java.util.List<ec.edu.espe.ecutrave.aerolineal.ws.Boleto> traerBoletosPorPersona(java.lang.String persona) {
        ec.edu.espe.ecutrave.aerolineal.ws.AerolineaTamews service = new ec.edu.espe.ecutrave.aerolineal.ws.AerolineaTamews();
        ec.edu.espe.ecutrave.aerolineal.ws.Aerolineaws port = service.getAerolineawsPort();
